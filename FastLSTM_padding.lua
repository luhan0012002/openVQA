require 'LSTM_padding'
local FastLSTM_padding, parent = torch.class("FastLSTM_padding", "LSTM_padding")
...
FastLSTM_padding.usenngraph = false

function FastLSTM_padding:__init(inputSize, outputSize, rho)
   parent.__init(self, inputSize, outputSize, rho, false)
end

function FastLSTM_padding:buildModel()
...
function FastLSTM_padding:nngraphModel()
...
function FastLSTM_padding:buildGate()
   error"Not Implemented"
end

function FastLSTM_padding:buildInputGate()
   error"Not Implemented"
end

function FastLSTM_padding:buildForgetGate()
   error"Not Implemented"
end

function FastLSTM_padding:buildHidden()
   error"Not Implemented"
end

function FastLSTM_padding:buildCell()
   error"Not Implemented"
end   
   
function FastLSTM_padding:buildOutputGate()
   error"Not Implemented"
end
