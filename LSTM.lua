...
local LSTM = {}
function LSTM.lstmImageAtt(input_size, rnn_size, conv_feature_size)
  ...
  local r2h = nn.Linear(conv_feature_size, 4 * rnn_size)(r)
  local preactivations = nn.CAddTable()({i2h, h2h, r2h})       -- i2h + h2h
